      ...
      try {
        if (resource === "media") {
          if (operation === "download") {
            ...
            const resourceName = this.getNodeParameter(
              "resourceName",
              i,
            ) as string;
          ...
          if (operation === "create") {
            ...
            if (jsonParameters) {
              ...
              const messageUi = this.getNodeParameter(
                "messageUi",
                i,
              ) as IMessageUi;
            ...
            if (jsonParameters) {
              ...
              const updateFieldsUi = this.getNodeParameter(
                "updateFieldsUi",
                i,
              ) as IDataObject;
          ...
          if (operation === "create") {
            ...
            const uri = this.getNodeParameter(
              "incomingWebhookUrl",
              i,
            ) as string;
